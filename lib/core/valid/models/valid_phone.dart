...
class ValidPhone extends FormzInput<String, ValidPhoneError> {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{'ValidPhone': value};
  }

  factory ValidPhone.fromMap(Map<String, dynamic> map) {
    final result = map['ValidPhone'];
    if (result == null) return const ValidPhone.pure();

    return ValidPhone.dirty(value: result.toString());
  }
}
