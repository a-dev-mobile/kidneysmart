...
class NetworkClient {
  ...
  // Method to remove AuthenticationInterceptor
  void removeAuthenticationInterceptor() {
    _dio.interceptors
        .removeWhere((interceptor) => interceptor is AuthenticationInterceptor);
  }

  // Method to add AuthenticationInterceptor
  void addAuthenticationInterceptor() {
    ...
    if (!_dio.interceptors
        .any((interceptor) => interceptor is AuthenticationInterceptor)) {
