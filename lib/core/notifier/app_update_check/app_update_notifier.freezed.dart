...
abstract class $AppUpdateStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ApiAppUpdateCheckRes apiAppUpdateCheckRes});
...
class _$AppUpdateStateImpl implements _AppUpdateState {
  ...
  @override
  String toString() {
    return 'AppUpdateState(apiAppUpdateCheckRes: $apiAppUpdateCheckRes)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, apiAppUpdateCheckRes);
