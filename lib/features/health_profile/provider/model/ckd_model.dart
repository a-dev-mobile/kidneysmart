...
//  *************************************
  ...
  factory CkdModel.fromMap(Map<dynamic, dynamic>? map) {
    ...
    return CkdModel(
      listCkd: map['listCkd'] != null ? (map['listCkd'] as List<dynamic>).map((e) => CkdItemModel.fromMap(e as Map<dynamic, dynamic>)).toList() : const [], 
  ...
  factory CkdModel.fromJson(String source) => CkdModel.fromMap(json.decode(source) as Map<String, dynamic>,);  
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CkdModel &&
            const DeepCollectionEquality().equals(other.listCkd, listCkd,) && 
            (identical(other.isShowCalcCreatinine, isShowCalcCreatinine) || other.isShowCalcCreatinine == isShowCalcCreatinine) && 
            (identical(other.enumCkdSelected, enumCkdSelected) || other.enumCkdSelected == enumCkdSelected) && 
  ...
  int get hashCode => Object.hashAll([
        runtimeType,
        const DeepCollectionEquality().hash(listCkd,),
