...
abstract class AppLocalizations {
  ...
  /// No description provided for @min_text_length.
  ///
  /// In ru, this message translates to:
  /// **'Минимальная длина текста'**
  String get min_text_length;
  ...
  /// No description provided for @document_already_used_text_1.
  ///
  /// In ru, this message translates to:
  /// **'Пользователь с такими паспортными данными уже существует'**
  String get document_already_used_text_1;

  /// No description provided for @document_already_used_text_2.
  ///
  /// In ru, this message translates to:
  ...
  /// No description provided for @document_already_used_text_3.
  ///
  /// In ru, this message translates to:
  /// **'Бесплатно по России'**
  String get document_already_used_text_3;

  /// No description provided for @enter_value_greater_0.
  ///
  /// In ru, this message translates to:
  /// **'Введите значение больше 0'**
  String get enter_value_greater_0;

  /// No description provided for @check_income.
  ///
  /// In ru, this message translates to:
  /// **'Проверьте доход'**
  String get check_income;

  /// No description provided for @your_monthly_income.
  ///
  /// In ru, this message translates to:
  /// **'Ваш доход в месяц'**
  String get your_monthly_income;

  /// No description provided for @document_already_used_text_4.
  ///
  /// In ru, this message translates to:
