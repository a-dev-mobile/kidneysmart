...
class Failure implements Exception {
  ...
  bool get empty => _tag == FailureTag.empty;
  bool get badRequest => _tag == FailureTag.badRequest;
  bool get unprocessableEntity => _tag == FailureTag.unprocessableEntity;
  bool get other => _tag == FailureTag.other;
